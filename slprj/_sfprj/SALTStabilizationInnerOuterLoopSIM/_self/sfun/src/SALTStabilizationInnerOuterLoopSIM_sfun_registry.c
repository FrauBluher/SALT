...
{
  extern unsigned int
    sf_SALTStabilizationInnerOuterLoopSIM_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_SALTStabilizationInnerOuterLoopSIM_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_SALTStabilizationInnerOuterLoopSIM_autoinheritance_info
  ...
  if (strcmp(machineName, "SALTStabilizationInnerOuterLoopSIM") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SALTStabilizationInnerOuterLoopSIM_autoinheritance_info(nlhs,plhs,
      3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "SALTStabilizationInnerOuterLoopSIM") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_SALTStabilizationInnerOuterLoopSIM_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_SALTStabilizationInnerOuterLoopSIM_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"SALTStabilizationInnerOuterLoopSIM")) {
    return(sf_SALTStabilizationInnerOuterLoopSIM_method_dispatcher(simstructPtr,
...
extern void SALTStabilizationInnerOuterLoopSIM_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    SALTStabilizationInnerOuterLoopSIM_terminator();
    sf_debug_terminate();
  }
...
extern void SALTStabilizationInnerOuterLoopSIM_initializer(void);
extern void SALTStabilizationInnerOuterLoopSIM_register_exported_symbols
  (SimStruct* S);
extern void SALTStabilizationInnerOuterLoopSIM_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  SALTStabilizationInnerOuterLoopSIM_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      SALTStabilizationInnerOuterLoopSIM_debug_initialize();
    }

    SALTStabilizationInnerOuterLoopSIM_initializer();
  }
